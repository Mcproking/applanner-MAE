...
class ClubOrgMenu extends StatefulWidget {
  final int initIndex;

  const ClubOrgMenu({super.key, this.initIndex = 0});

  @override
  State<StatefulWidget> createState() => _ClubOrgMenuState();
}

class _ClubOrgMenuState extends State<ClubOrgMenu> {
  String _name = 'Temp';
  String? _profileUrl;
